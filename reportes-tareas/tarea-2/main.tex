...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}[(a)]
            ...
            \[ \begin{cases}
                    U(0,y) = \max\pp{e^{\frac{1}{2}(a+1)y} - e^{\frac{1}{2}(a-1)y},~0},\\
                    U(\tau,0) = 0,\\
                    U(\tau,L) = e^{\frac{1}{2}(a+1)L + \frac{1}{4}(a+1)^2\tau} - e^{\frac{1}{2}(a-1)L + \frac{1}{4}(a-1)^2\tau},
                \end{cases} \]
            donde $L$ es un valor suficientemente grande para aproximar la
            condición en el infinito.

            Dado que el MDA se aplica directamente a problemas con condiciones de Dirichlet homogéneas, se descompone
            ...
            \[ u(\tau,y) = u(0,y) - L^{-1}w_\tau + \int_0^\tau u_{yy}(s,y)ds = -L^{-1}w_\tau + \int_0^\tau u_{yy}(s,y)ds, \]
            ya que $u(0,y)=0$.
            ...
            \begin{itemize}
                ...
                \[ u_n(\tau,y) = \frac{\tau^n}{n!} \frac{\partial^{2n} u_0}{\partial y^{2n}}(0,y), \]
            \end{itemize}
            ...
            \[ U(\tau,y) = u(\tau,y) + w(\tau,y),\qquad V(\tau,y) = e^{-a y - b\tau} U(\tau,y), \]
            y finalmente el precio de la opción de compra
            \[ C(t,x) = K e^{-\frac{1}{2}(a+1)y - \frac{1}{4}(a-1)^2\tau}\; U(\tau,y), \]
